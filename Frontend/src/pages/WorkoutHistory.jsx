  ...
  return (
    <div className="space-y-8 animate-[fadeIn_0.4s_ease-out]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-200 pb-6">
        <div>
          <h1 className="text-4xl font-extrabold text-slate-900">Workout History 📚</h1>
      ...
      {filteredPlans.length === 0 ? (
        <div className="bg-white border border-slate-200/80 p-12 rounded-3xl text-center text-slate-500 text-sm flex flex-col items-center justify-center gap-3">
          ...
          <p className="font-semibold text-slate-500">No matching routines found</p>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-slate-900 font-bold text-base">Workout Session Routine</h4>
