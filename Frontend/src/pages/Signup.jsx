      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 bg-[#0F172A] rounded-3xl overflow-hidden shadow-[0_10px_50px_rgba(0,0,0,0.4)] border border-slate-800">
        ...
        <div className="relative hidden md:flex flex-col justify-between p-12 bg-gradient-to-br from-emerald-950 via-[#0b0f19] to-slate-900 overflow-hidden">
          ...
          <div className="relative z-10 mt-8 pt-8 border-t border-slate-800 flex items-center gap-6">
            <div>
              <p className="text-3xl font-extrabold text-[#A3E635]">25M+</p>
              <p className="text-xs text-slate-400 uppercase tracking-wider">Workouts Completed</p>
            </div>
            <div className="w-px h-10 bg-slate-800" />
            <div>
              <p className="text-3xl font-extrabold text-[#06B6D4]">4.9/5</p>
              <p className="text-xs text-slate-400 uppercase tracking-wider">Member Rating</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-16 flex flex-col justify-center">
          <div className="max-w-md w-full mx-auto">
            <h2 className="text-4xl font-extrabold text-white mb-2">Join FitFlow</h2>
            <p className="text-slate-400 mb-8">Get started by building your premium profile.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#1E293B] border border-slate-700 focus:border-[#A3E635] text-white px-4 py-3 rounded-xl outline-none transition-all duration-200 placeholder-slate-500"
                  required
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-[#A3E635] hover:bg-[#bbf055] text-slate-950 font-bold py-3.5 rounded-xl shadow-[0_4px_20px_rgba(163,230,53,0.25)] transition-all duration-200 hover:scale-[1.01] active:scale-[0.99] mt-3"
              >
                Create Account
              </button>
