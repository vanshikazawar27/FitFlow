  ...
  return (
    <div className="space-y-8 animate-[fadeIn_0.4s_ease-out]">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-slate-800 pb-6">
        <div>
          <h1 className="text-4xl font-extrabold text-white">Diet History 🍎</h1>
          <p className="text-slate-400 mt-1">Review previously generated custom meal matrices.</p>
        </div>
      ...
      {filteredPlans.length === 0 ? (
        <div className="bg-[#0F172A]/30 border border-slate-800/80 p-12 rounded-3xl text-center text-slate-500 text-sm flex flex-col items-center justify-center gap-3">
          ...
          <p className="font-semibold text-slate-400">No matching diet plans found</p>
              ...
              >
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-base">Custom Meal Plan Matrix</h4>
